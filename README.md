...
| 三段式 | `1-5-4044` | 丰巢、菜鸟 |
| 四段式 | `A1-2-3-45` | 京东快递柜 |
| 字母前缀三段式 | `A8-3-3315` | 驿站/快递柜 (A/B/C 前缀) |
...
| v1.0.2 | 截屏流程重构 |
| v1.0.3 | 外部接收 (分享/拖放直达)，OCR 横杠归一化、来源正则匹配、取件码格式，地图验证、去重重写、自学习闭环 |
| v1.0.4 | 地址管线重构 (S6合并/S2跨行/S0折叠补全)、AI 双路径接入、快递100 反向验证、稳定性与 UI 优化 |
